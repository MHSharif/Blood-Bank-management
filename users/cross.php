...
if (isset($_POST['submitBtn'])) {
    ...
    $db = new DBConnect();
    $flag = $db->registerUser($firstName, $lastName, $gender, $bType, $address, $city, $mobile);
    ...
    <div class="col-md-7">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="col-md-3">
                    <img src="assets/save.jpg" class="img img-responsive">
                </div>
                <p>We will come to your address and will take your blood sample to crossmatch with the patient who needs blood.Thats how we are trying to save valuable times of yours 
				Just by registering below you will make an agreement
